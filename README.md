...
| [Nutritionist-Bot](https://github.com/Breez97/Nutritionist-Bot) | <p align="justify">The Nutrition  Bot is a Telegram bot that recommends calorie-optimized meal plans based on user dietary goals by gathering and scrawl information from the internet.</p> | <p align="justify">Java 17, Spring Boot, Spring Web, Spring Data JPA, Kafka, PostgreSQL, Maven, Python.</p>|
